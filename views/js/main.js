...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // Reduced the number of calls to determineDX function from 100 to 1 by moving var dx out of the for loop.
    // Var dx and newwidth moved outside of for loop since their values only need to be calculated once.
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // For monitors that are 1920 x 1080, pizzas less than 32 would not fill the screen.
  // Anything over 32 that is not divisible by 8 is rounded down to 4 or not seen on screen.
  for (var i = 0; i < 32; i++) {
